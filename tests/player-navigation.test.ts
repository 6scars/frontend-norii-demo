...
await test('następny utwór przesuwa indeks i zawija koniec playlisty', () => {
...
await test('poprzedni utwór przesuwa indeks i zawija początek playlisty', () => {
...
await test('nawigacja zachowuje dotychczasowe zachowanie pustego indeksu', () => {
...
await test('nawigacja zwraca null dla pustej playlisty i odrzuca niegrywalny rekord', () => {
