...
await test('wysokość panelu pozostaje pomiędzy dwoma punktami zatrzymania', () => {
...
await test('szybki gest wybiera kierunek niezależnie od połowy wysokości', () => {
...
await test('wolny gest zatrzymuje panel w najbliższym punkcie', () => {
