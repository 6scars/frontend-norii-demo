...
await test('radio buduje trzy stacje z realnego katalogu bez zmiany wejścia', () => {
...
await test('radio odrzuca niegrywalne rekordy i bezpiecznie obsługuje pusty katalog', () => {
