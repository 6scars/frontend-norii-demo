...
import { useRecentlyPlayedContext } from '../../modules/RecentlyPlayed/useRecentlyPlayedContext.js'
...
function SongShelf({ headingId, songs, title, onPlay, viewAllTo }) {
  return (
...
export default function HomePage({ songs: songsFromParent }) {
  ...
  const playSong = (song, queue = model.selected) => {
