...
import { useDiscovery } from '../../modules/Discovery/useDiscovery.ts'
import type { DiscoverySection } from '../../modules/Discovery/useDiscovery.ts'
...
const sections: ReadonlyArray<{ value: DiscoverySection; label: string }> = [
...
export default function DiscoverPage() {
  ...
  const playTrack = (songId: EntityId | null) => {
