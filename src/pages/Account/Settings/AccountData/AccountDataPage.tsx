...
import { USERNAME_MAX_LENGTH, updateUsername } from '../../../../modules/Account/account-api.ts'
...
export default function AccountDataPage() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setFeedback({
        message: getErrorMessage(error, 'Nie udało się zapisać nazwy użytkownika.'),
        type: 'error',
      })
    }
  }
  ...
  return (
    <div className="account-data-page">
      ...
      <section className="account-data-card" aria-labelledby="username-section-title">
        ...
        <form className="account-data-form" onSubmit={(event) => { void handleSubmit(event) }}>
